...
export default function faq() {
  return (
    <Layout page="FAQ">
      <div className="faq">
        <div className="faq-content container rounded">
          <h1>FAQ</h1>
          <p>
            ...
            magnam veniam laudantium sapiente temporibus magni nihil
            accusantium. Delectus dolore odit iure esse, non sapiente
            consequuntur, at aperiam optio eveniet vel sed!
          </p>
          <div className="row question-section">
            <div className="col faq-1 shadow p-4 m-3  rounded">
              ...
              <p>
                ...
                adipisicing elit. Praesentium, doloremque. Lorem, ipsum dolor
          ...
          <div class="accordion accordion-flush" id="accordionFlushExample">
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="flush-headingThree">
                ...
                >
                  Je n'ai pas reçu l'e-mail pour confirmer mon inscription,
                  comment faire ?
                </button>
              </h2>
              <div
